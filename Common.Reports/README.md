...
**Acontplus.Common.Reports** is a .NET library designed to simplify the generation of RDLC (Report Definition Language Client-side) reports. It includes features for creating, exporting, and managing reports using RDLC in your .NET applications.
...
You can install the package via [NuGet](https://www.nuget.org/packages/Acontplus.Common.Reports/).

### .NET CLI

```
dotnet add package Acontplus.Common.Reports
```

### Package Manager Console
```
Install-Package Acontplus.Common.Reports
```
## Usage
...
```
using Acontplus.Common.Reports.Services;
